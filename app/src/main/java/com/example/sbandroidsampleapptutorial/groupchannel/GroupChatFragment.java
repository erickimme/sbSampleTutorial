...
import com.example.sbandroidsampleapptutorial.utils.UrlPreviewInfo;
import com.example.sbandroidsampleapptutorial.utils.WebUtils;
        ...
        SendBird.addChannelHandler(CHANNEL_HANDLER_ID, new SendBird.ChannelHandler() {
            ...
            public void onMessageReceived(BaseChannel baseChannel, BaseMessage baseMessage) {
                if (baseChannel.getUrl().equals(mChannelUrl)) {
                    ...
                    UserMessage message = (UserMessage) baseMessage;
                    // local push notification
//                    sendNotification(getActivity(), message.getMessage(), baseChannel.getUrl());
                    sendNotificationWithChannelName(getActivity(), message.getMessage(), baseChannel.getUrl());
                }
            }
    ...
    private void sendNotificationWithChannelName(Context context, String message, String channelUrl) {
        NotificationManager notificationManager = (NotificationManager) context.getSystemService(Context.NOTIFICATION_SERVICE);
